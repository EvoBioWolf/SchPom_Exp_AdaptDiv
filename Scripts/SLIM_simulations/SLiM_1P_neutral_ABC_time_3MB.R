...
output <- system2("/proj/uppstore2017159/b2014286/private/tools/SLiM/build/slim", c("-d", paste0("gen=", gen), " ~/private/Uppsala/Analyses/04_Genomic_analyses/11_phaseIII/scripts/SLiM_1P_neutral_ABC_time_3MB.txt"), stdout=T)
