...
FULL_ADAPTERS_FILENAME="pombe-candidate-adapters-v4.conf"
DEFAULT_ADAPTERS="$PWD/$FULL_ADAPTERS_FILENAME"
...
$PWD/shuffleSequences_fastq.pl --subset $SUBSET $Read1 $Read2 $Read12_interleaved
